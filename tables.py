...
def planetstab(date):
    # generates a LaTeX table for the navigational plantets (traditional)
    tab = r'''\noindent
...
def planetstabm(date):
    # generates a latex table for the navigational plantets (modern)
    tab = r'''\vspace{6Pt}\noindent
...
"""
    ...
    for i in range(3):
        datestr = r"""\rule{0pt}{2.4ex}%s %s %s""" %(ephem.date(date+i).datetime().strftime("%b"), ephem.date(date+i).datetime().strftime("%d"), ephem.date(date+i).datetime().strftime("%a"))
        m = m + '\\hline \n'
        if config.tbls == "m":
    ...
    hp = '\\hline \n'
    hp = hp + '\multicolumn{2}{|r}{\\rule{0pt}{2.4ex}\\textbf{Horizontal parallax}} & \multicolumn{1}{c|}{}\\\ \n'
...
def twilighttab(date):
    ...
    if config.tbls == "m":
        tab = tab + r"""\hline
    \multicolumn{1}{|c|}{\multirow{3}{*}{\textbf{Lat.}}} & 
    \multicolumn{2}{c}{\multirow{2}{*}{\footnotesize{\textbf{Twilight}}}} & 
    \multicolumn{1}{|c|}{\multirow{3}{*}{\textbf{Sunrise}}} & 
    \multicolumn{1}{c|}{\multirow{3}{*}{\textbf{Sunset}}} & 
    \multicolumn{2}{c|}{\multirow{2}{*}{\footnotesize{\textbf{Twilight}}}} \\ 
...
#   Moonrise & Moonset ...
    if config.tbls == "m":
        tab = tab + r"""\hline
    \multicolumn{1}{|c|}{\multirow{3}{*}{\textbf{Lat.}}} & 
    \multicolumn{3}{c|}{\multirow{2}{*}{\footnotesize{\textbf{Moonrise}}}} & 
    \multicolumn{3}{c|}{\multirow{2}{*}{\footnotesize{\textbf{Moonset}}}} \\ 
...
#   Equation of Time section ...
    ...
    \multicolumn{3}{c|}{\multirow{2}{*}{\footnotesize{\textbf{Sun}}}} & 
    \multicolumn{3}{c|}{\multirow{2}{*}{\footnotesize{\textbf{Moon}}}} \\ 
    \multicolumn{1}{|c|}{} & & & \multicolumn{1}{c|}{} & & & \multicolumn{1}{c|}{} \\
...
"""
        ...
        tab = tab + r"""\hline
    \multicolumn{1}{|c|}{\rule{0pt}{2.4ex}\multirow{3}{*}{\textbf{Day}}} & 
